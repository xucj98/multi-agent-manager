...
本轮已读取最新发布的收尾验收和调度要求，沿当前安装操作；项目配置迁移等待Manager通知。按用户要求移除报告task_revision首行。由task status的jobs.unarchived取得ID，逐个job status实时探测，checked_at为2026-09-10 23:32:35–37+08:00，14路全部running且无error，身份核对由MAM内置完成。

两机快照为 `2026-09-10T23:33:26+08:00`。14个原PID实际command/cwd/解释器、GPU/seed/exp_name和受控环境均匹配，采样状态均R。各路更新较本报告此前20:59快照均增加；Manager另已于22:17检查，本轮没有重复其检查。最新日志距采样0.1–9.7秒，未见Traceback/CUDA error/OOM/RESOURCE_EXHAUSTED错误，全部14卡利用率100%。

| host/GPU | config / seed | PID | MAM job | 最新 updates | 最新可见 loss@step | s/update | 剩余 ETA |
| --- | --- | ---: | --- | ---: | --- | ---: | --- |
| wuwen-1/0 | rearrange full t+1 / 0 | 4186829 | `89dcc92f-365e-409a-87d3-e6e82b66adba` | 约 14.7k | 未落盘 | 3.7 | 约 5h29m |
| wuwen-1/1 | rearrange full t+30 / 0 | 4186841 | `db46bdd0-0ec2-41c1-9c98-baca9ffd6f5b` | 约 14.8k | 未落盘 | 3.7 | 约 5h24m |
| wuwen-1/2 | rearrange serial lag30 / 0 | 9003 | `d682fab7-3cbc-4b7e-a31a-b959bbd2695c` | 约 14.6k | 未落盘 | 3.7 | 约 5h34m |
| wuwen-1/3 | rearrange no-memory / 0 | 4186839 | `2774d038-5a23-4184-b16a-92fa1fd88019` | 约 14.5k | 未落盘 | 3.8 | 约 5h45m |
| wuwen-1/4 | put-back full t+1 / 0 | 12435 | `463092be-02b4-4bfa-bf12-8eae2416a244` | 约 13.8k | 0.0009@13800 | 3.8 | 约 6h32m |
| wuwen-1/5 | put-back full t+30 / 0 | 12436 | `6e2601ea-e091-4e63-9c31-e90895ca5ffe` | 约 14.2k | 0.0010@14100 | 3.7 | 约 6h01m |
| wuwen-1/6 | rearrange full t+1 / 1 | 4186835 | `95a88ee3-1a90-4e2e-baa1-50a1cd6f4eb0` | 约 15.0k | 未落盘 | 3.7 | 约 5h08m |
| wuwen-1/7 | rearrange full t+30 / 1 | 4186832 | `fa1d8437-1fb7-48a5-8d37-2233e8e06767` | 约 15.0k | 未落盘 | 3.7 | 约 5h02m |
| 本机/0 | put-back full t+30 / 2 | 2944062 | `dcb7d214-5351-4301-b0cd-1bac56f59de3` | 约 7.14k | 0.0014@7100 | 3.6 | 约 12h55m |
| 本机/1 | put-back full t+1 / 2 | 2918573 | `ee13298c-d10c-4fa4-9be9-875b417fb9a1` | 约 7.47k | 0.0016@7400 | 3.7 | 约 12h56m |
| 本机/4 | rearrange full t+1 / 2 | 2467720 | `b3d46ac6-b2b7-4ea2-b3ad-df74a2bdac7e` | 约 12.4k | 0.0011@12300 | 3.7 | 约 7h49m |
| 本机/5 | rearrange full t+30 / 2 | 2467721 | `0c82949f-f5c6-4772-aea6-1967e9cc2680` | 约 12.2k | 0.0011@12200 | 3.7 | 约 8h03m |
| 本机/6 | put-back full t+1 / 1 | 2467722 | `f04d1b9c-4a77-4034-ac6c-c7240d9b20a8` | 约 12.4k | 0.0011@12300 | 3.7 | 约 7h49m |
| 本机/7 | put-back full t+30 / 1 | 2467723 | `3e67c9de-fc4f-4a94-a2da-7dccbdec9b2e` | 约 12.3k | 0.0011@12200 | 3.7 | 约 8h00m |

kit为日志三位有效数字取整，保留约数；ETA按近期速率估计并四舍五入至分钟，不计最终保存。当前约3.6–3.8秒/update。wuwen-1预计9月11日约04:36–06:05完成更新，当前未见越过12:00预留截止时间的风险，实际保存与释放仍待验收。本机GPU4–7约07:22–07:36，GPU0/1约12:28–12:29完成更新；本机已取消预留限制。

远端GPU4/5各138/141条、本机GPU0/1各71/74条、本机GPU4/5/6/7各123/122/123/122条已落盘loss/grad_norm/param_norm全部有限。最新完整标量：

| host/GPU | Step | loss | grad_norm | param_norm |
| --- | ---: | ---: | ---: | ---: |
| wuwen-1/4 | 13800 | 0.0009 | 0.0330 | 1804.1787 |
| wuwen-1/5 | 14100 | 0.0010 | 0.0359 | 1804.0801 |
| 本机/0 | 7100 | 0.0014 | 0.0372 | 1803.4542 |
| 本机/1 | 7400 | 0.0016 | 0.0429 | 1803.5505 |
| 本机/4 | 12300 | 0.0011 | 0.0350 | 1804.1709 |
| 本机/5 | 12200 | 0.0011 | 0.0371 | 1804.1378 |
| 本机/6 | 12300 | 0.0011 | 0.0334 | 1804.0435 |
| 本机/7 | 12200 | 0.0011 | 0.0362 | 1803.9451 |

以上为区间均值，不扩展为每个update原始loss证明。旧远端GPU0/1/2/3/6/7的Step标量仍各为零，有限loss尚未证实；保留stdout缓冲边界，无注入或重启。

两机HEAD均为 `d10cc01d44c10e5ed0cd8c228d9409dd6cabac50`，git status为空，源码/参数冻结。本次只巡检和报告发布，无新训练或重复smoke。14路尚未结束：自然结束后核对退出状态、唯一最终20000 BF16 checkpoint和metadata完整性、完整参数/无optimizer/恢复要求；检查本任务登记进程及子进程退出、显存释放，仅清理确认属于本任务的残留并留痕，不凭显存占用终止不明进程。

最新调度：wuwen-1结束、保存释放后整机8卡保持空闲，直到另行允许，不接续任何GPU任务；本机0–7均可按原授权继续使用，启动前核对可用性，后续smoke/eval安排在本机。若远端ETA超出预留截止时间，报告Manager裁决，不擅自终止。
...
| --- | --- | --- | --- | --- |
| wuwen-1 / 0–7 | 73,489–73,507 / 7,543–7,561 | 全部100% | 51–69°C | 831,294,826 KiB（约 792.8 GiB） |
| 本机 / 0,1,4–7 | 73,405–73,406 / 各7,633 | 全部100% | 58–71°C | 876,631,147 KiB（约 836.0 GiB） |

共享/mnt/public可用9,994,881,728,512 bytes（约 9.09 TiB），未见内存/显存/磁盘压力。两机put-back norm SHA-256均保持 `7a014e42dc9d51c8601b05dca5c876c58dda1308e61d1619e3d1c367baa7f261`。
...
下一检查：`2026-09-11T00:32:00+08:00`，远端八路与本机GPU0/1/4–7合并为十四路巡检，由 Manager 按计划唤醒。若收到 MAM job attention 或异常通知则提前处理。十四路的 20k 完成、唯一 20000 BF16 checkpoint、完整参数/无 optimizer/恢复验证与评测交接仍待训练结束后完成。
