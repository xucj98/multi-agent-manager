...
- 已完成：截至 `2026-09-10T08:27:34+08:00`，full/no-memory 五项已到 164–179 updates，serial 到 23 updates。进度日志持续更新且未见 `Traceback`、`ERROR`、`nan` 或 `inf`；full/no-memory 稳定约 3.7–3.8 s/update，serial 已收敛至约 3.9 s/update。
...
| --- | --- | --- | ---: | --- | --- | --- |
| 0 | full t+1 / 0 | `memory20k_e7e5ac54_rearrange_full_t_plus_1_s0` | 4186829 | `89dcc92f-365e-409a-87d3-e6e82b66adba` | 08:08 启动；164 updates | 约 20h36m |
| 1 | full t+30 / 0 | `memory20k_e7e5ac54_rearrange_full_t_plus_30_s0` | 4186841 | `db46bdd0-0ec2-41c1-9c98-baca9ffd6f5b` | 08:08 启动；164 updates | 约 20h30m |
| 2 | serial lag30 / 0 | `memory20k_e7e5ac54_rearrange_serial_lag30_s0` | 9003 | `d682fab7-3cbc-4b7e-a31a-b959bbd2695c` | 08:18 启动；23 updates | 约 21h22m（初步） |
| 3 | no-memory / 0 | `memory20k_e7e5ac54_rearrange_no_memory_s0` | 4186839 | `2774d038-5a23-4184-b16a-92fa1fd88019` | 08:08 启动；164 updates | 约 20h43m |
| 6 | full t+1 / 1 | `memory20k_e7e5ac54_rearrange_full_t_plus_1_s1` | 4186835 | `95a88ee3-1a90-4e2e-baa1-50a1cd6f4eb0` | 08:08 启动；179 updates | 约 20h12m |
| 7 | full t+30 / 1 | `memory20k_e7e5ac54_rearrange_full_t_plus_30_s1` | 4186832 | `fa1d8437-1fb7-48a5-8d37-2233e8e06767` | 08:08 启动；179 updates | 约 20h10m |
...
下一检查时间：约 `2026-09-10T09:28:00+08:00` 做首个小时巡检；任何 MAM job attention、显存异常或 Manager 新路径授权均立即检查。GPU4/5 继续等待 put-back norm / loader 证据，绝不提前启动。
