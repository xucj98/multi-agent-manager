...
使用mam task status返回workspace下review/的只读快照；SHA256SUMS固定本次输入。先读docs/MEMORY_CONFIG.zh-CN.md，再读docs/memory_config/memory.schema.yaml与五个实例。两个SAMPLES/SWAP_T文档是解释，FRAMEWORK是研究背景。不要读取其他review任务的报告或母对话。
