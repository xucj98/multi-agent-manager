...
- F0 BF16临时评测副本：按07:04替代要求不再迁移，交owner 47a91a44清理；清理完成状态以该owner报告为准。本任务不移动、不重建副本。原FP32 checkpoint和正式实验结果保留，历史CPU参数验证证据publication 04eee7a5cf20b4011406dbddc99bbbb148d7e1b8保留。
