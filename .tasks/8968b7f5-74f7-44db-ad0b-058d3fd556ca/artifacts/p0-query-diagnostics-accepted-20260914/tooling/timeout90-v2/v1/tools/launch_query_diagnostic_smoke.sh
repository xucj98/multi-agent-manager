...
EXPERIMENT_GROUP=query_diagnostic_c2_20260914
GPU=6

case "$VARIANT" in
  full_t_plus_1)
    RUN_ID=query_diagnostic_full_t_plus_1
    EXPECTED_RESULT_RUN=query_diagnostic_full_t_plus_1_smoke_20260914
  ...
  serial_lag30)
    ...
    EXPECTED_RESULT_RUN=query_diagnostic_serial_lag30_smoke_20260914
...
DIAGNOSTIC_DIR="$RECORDS/diagnostics/$VARIANT"
MANIFEST="$RECORDS/manifests/$VARIANT/runner_input_manifest.json"
SCHEDULER_CONFIG="$RECORDS/manifests/$VARIANT/scheduler_config.yaml"
